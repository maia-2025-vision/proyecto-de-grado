...
Esta carpeta existe para cumplir la rúbrica: aquí dejamos referencias claras a los datos. 
Los datos completos (train/val/test, groundtruth, parches) siguen versionados con DVC en `data/`.
...
## Administración de datos con comando `dvc`
...
- Por buenas prácticas de github, No subimos datasets completos ni modelos pesados al repo; se bajan con DVC/S3.

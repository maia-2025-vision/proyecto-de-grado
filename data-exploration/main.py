import pandas as pd
from utils import analyze_area_statistics, analyze_dataset, generate_split_table, get_top_n_bboxes_in_area_range, load_all_bbox_data, plot_bbox_area_histogram_from_data, plot_total_species_comparison

def generate_markdown_report(dataset_summaries, output_md_path, class_distribution_image_name, stats_absolute, 
                             stats_relative_global, stats_relative_split, image_sizes, top_bboxes=None):
    ...
    with open(output_md_path, "w", encoding="utf-8") as f:
        ...
        if top_bboxes:
            ...
            columns_to_show = ["dataset", "split", "category", "area", "area_relative", "image_name", "bbox"]
...
def main():
    ...
    dataset_summaries = {
        name: analyze_dataset(path, name)
